    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom py-3 px-4">
                ...
                <h4 class="fw-bold m-0">Galeri Kegiatan</h4>
            </nav>

            <div class="container-fluid p-4">
                <div class="card border-0 shadow-sm p-4">
                    <div class="d-flex justify-content-between mb-4">
                        <h5 class="fw-bold">Daftar Foto Dokumentasi</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><img src="../../../assets/img/galeri/<?= $row['gambar']; ?>" width="80" class="rounded"></td>
                                    <td class="fw-bold"><?= $row['judul']; ?></td>
                                    <td><?= date('d/m/Y', strtotime($row['tanggal'])); ?></td>
                                    <td class="text-center">
                                        <a href="edit.php?id=<?= $row['id_galeri']; ?>" class="btn btn-warning btn-sm text-white"><i class="fas fa-edit"></i></a>
                                        <a href="proses.php?aksi=hapus&id=<?= $row['id_galeri']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus galeri ini?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
